	...
	*/
	...
	public static void battery1() throws Exception {
			...
			for(int j = 0; j < ar.size(); j++) {
				displayLine = 0;
				Comparable[] nexc = ((Result)ar.get(j)).toArray();
				System.out.println("9."+j+") FindTailSet(<obj>,<obj>,<obj>) using domain="+nexc[0]+",map="+nexc[1]+",range="+nexc[2]);
				it = Relatrix.findTailSet(nexc[0],nexc[1],nexc[2]);
				while(it.hasNext()) {
					Object o = it.next();
					Result c = (Result)o;
			...
			for(int j = 0; j < ar.size(); j++) {
				...
				Comparable[] nexc = ((Result)ar.get(j)).toArray();
				//RelatrixTailSetIterator.DEBUG = true;
				System.out.println("10."+j+") FindTailSet(*,*,<obj>,String.class, String.class) using range="+nexc[2]);		
			...
			for(int j = 0; j < ar.size(); j++) {
				...
				Comparable[] nexc = ((Result)ar.get(j)).toArray();
				//RelatrixTailSetIterator.DEBUG = true;
				System.out.println("11."+j+") FindTailSet(*,<obj>,*, String.class, Long.class) using map="+nexc[1]);		
			...
			for(int j = 0; j < ar.size(); j++) {
				displayLine =0;
				Comparable[] nexc = ((Result)ar.get(j)).toArray();
				System.out.println("12."+j+") FindTailSet(<obj>,*,*,String.class, Long.class) using domain="+nexc[0]);		
			...
			for(int j = 0; j < ar.size(); j++) {
				...
				displayLine = 0;
				Comparable[] nexc = ((Result)ar.get(j)).toArray();
				System.out.println("13."+j+") FindTailSet(*,<obj>,<obj>,String.class) using map="+nexc[1]+" range="+nexc[2]);		
			...
			for(int j = 0; j < ar.size(); j++) {
				displayLine = 0;
				Comparable[] nexc = ((Result)ar.get(j)).toArray();
				System.out.println("14."+j+") FindTailSet(<obj>,*,<obj>,String.class) using domain="+nexc[0]+", range="+nexc[2]);		
			...
			for(int j = 0; j < ar.size(); j++) {
				displayLine=0;
				Comparable[] nexc = ((Result)ar.get(j)).toArray();
				System.out.println("15."+j+") FindTailSet(<obj>,<obj>,*, Long.class) using domain="+nexc[0]+", map="+nexc[1]);		
			...
			System.out.println("---------");
			System.out.println("range instance...");
			for(int j = 0; j < ar.size(); j++) {
				displayLine=0;
				Comparable[] nexc = ((Result)ar.get(j)).toArray();
			...
			System.out.println("---------");
			System.out.println("domain instance...");
			for(int j = 0; j < ar.size(); j++) {
				displayLine=0;
				Comparable[] nexc = ((Result)ar.get(j)).toArray();
			...
			System.out.println("---------");
			System.out.println("map and range instances...");
			for(int j = 0; j < ar.size(); j++) {
				displayLine=0;
				Comparable[] nexc = ((Result)ar.get(j)).toArray();
			...
			System.out.println("---------");
			System.out.println("domain and range instances...");
			for(int j = 0; j < ar.size(); j++) {
				displayLine=0;
				Comparable[] nexc = ((Result)ar.get(j)).toArray();
			...
			System.out.println("---------");
			System.out.println("domain and map instances...");
			for(int j = 0; j < ar.size(); j++) {
				displayLine=0;
				Comparable[] nexc = ((Result)ar.get(j)).toArray();
