	...
	*/
	...
	public static void battery1(TransactionId xid2) throws Exception {
		...
		for(int j = 0; j < ar.size(); j++) {
			displayLine = 0;
			System.out.println("9."+j+") FindHeadSet(xid,<obj>,<obj>,<obj>) using domain="+ar.get(j).getDomain()+",map="+ar.get(j).getMap()+",range="+ar.get(j).getRange());
			it = RelatrixTransaction.findHeadSet(xid2,ar.get(j).getDomain(), ar.get(j).getMap(), ar.get(j).getRange());
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			System.out.println("10."+j+") FindHeadSet(xid,*,*,<obj>,String.class, String.class) using range="+ar.get(j).getDomain());		
			it = RelatrixTransaction.findHeadSet(xid2,'*', '*', ar.get(j).getDomain(), String.class, String.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
		...
		for(int j = 0; j < ar.size(); j++) {
			displayLine = 0;
			//RelatrixHeadsetIterator.DEBUG = true;
			System.out.println("11."+j+") FindHeadSet(xid,*,<obj>,*, String.class, Long.class) using map="+ar.get(j).getDomain());		
			it = RelatrixTransaction.findHeadSet(xid2,'*', ar.get(j).getDomain(), '*',String.class, Long.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			displayLine =0;
			System.out.println("12."+j+") FindHeadSet(xid,<obj>,*,*,String.class, Long.class) using domain="+ar.get(j).getDomain());		
			it = RelatrixTransaction.findHeadSet(xid2,ar.get(j).getDomain(), '*', '*',String.class, Long.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
		...
		for(int j = 0; j < ar.size(); j++) {
			...
			displayLine = 0;
			System.out.println("13."+j+") FindHeadSet(xid,*,<obj>,<obj>,String.class) using map="+ar.get(j).getDomain()+" range="+ar.get(j).getMap());		
			it = RelatrixTransaction.findHeadSet(xid2,'*', ar.get(j).getDomain(), ar.get(j).getMap(), String.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			displayLine = 0;
			System.out.println("14."+j+") FindHeadSet(xid,<obj>,*,<obj>,String.class) using domain="+ar.get(j).getDomain()+", range="+ar.get(j).getMap());		
			it = RelatrixTransaction.findHeadSet(xid2,ar.get(j).getDomain(), '*', ar.get(j).getMap(), String.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
		...
		for(int j = 0; j < ar.size(); j++) {
			displayLine=0;
			System.out.println("15."+j+") FindHeadSet(xid,<obj>,<obj>,*, Long.class) using domain="+ar.get(j).getDomain()+", map="+ar.get(j).getMap());		
			it = RelatrixTransaction.findHeadSet(xid2,ar.get(j).getDomain(), ar.get(j).getMap(), '*', Long.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
		...
		for(int j = 0; j < ar.size(); j++) {
			displayLine=0;
			System.out.println("16."+j+") FindHeadSet(xid,*,*,<obj>, String.class, String.class) using range="+ar.get(j).getDomain());		
			it = RelatrixTransaction.findHeadSet(xid2,'*', '*', ar.get(j).getDomain(), String.class, String.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
			...
			displayLine=0;
			System.out.println("17."+j+") FindHeadSet(xid,*,<obj>,*, String.class, Long.class) using map="+ar.get(j).getDomain());		
			it = RelatrixTransaction.findHeadSet(xid2,'*', ar.get(j).getDomain(), '*', String.class, Long.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
			...
			displayLine=0;
			System.out.println("18."+j+") FindHeadSet(xid,<obj>,*,*, String.class, Long.class) using domain="+ar.get(j).getDomain());		
			it = RelatrixTransaction.findHeadSet(xid2,ar.get(j).getDomain(), '*', '*', String.class, Long.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
		...
		for(int j = 0; j < ar.size(); j++) {
			displayLine=0;
			System.out.println("19."+j+") FindHeadSet(xid,*,<obj>,<obj>, String.class) using map="+ar.get(j).getDomain()+" range="+ar.get(j).getMap());		
			it = RelatrixTransaction.findHeadSet(xid2,'*', ar.get(j).getDomain(), ar.get(j).getMap(), String.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
			...
			displayLine =0;
			System.out.println("20."+j+") FindHeadSet(xid,<obj>,*,<obj>,String.class) using domain="+ar.get(j).getDomain()+" range="+ ar.get(j).getMap());		
			it = RelatrixTransaction.findHeadSet(xid2,ar.get(j).getDomain(), '*', ar.get(j).getMap(), String.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
			...
			displayLine =0;
			System.out.println("21."+j+") FindHeadSet(xid,obj>,<obj>,*,Long.class) using domain="+ar.get(j).getDomain()+" map="+ar.get(j).getMap());		
			it = RelatrixTransaction.findHeadSet(xid2,ar.get(j).getDomain(), ar.get(j).getMap(), '*',Long.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
