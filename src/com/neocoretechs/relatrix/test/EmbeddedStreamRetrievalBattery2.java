	...
	*/
	...
	public static void battery1() throws Exception {
		...
		for(int j = 0; j < ar.size(); j++) {
			displayLine = 0;
			System.out.println("9."+j+") findHeadStream(<obj>,<obj>,<obj>) using domain="+ar.get(j).getDomain()+",map="+ar.get(j).getMap()+",range="+ar.get(j).getRange());
			Relatrix.findHeadStream(ar.get(j).getDomain(), ar.get(j).getMap(), ar.get(j).getRange()).forEach(o->{
				Result c = (Result)o;
				displayCtrl();
				if(DISPLAY || DISPLAYALL)
					System.out.println(displayLine+"="+c);
			...
			System.out.println("10."+j+") findHeadStream(*,*,<obj>,String.class, String.class) using range="+ar.get(j).getDomain());		
			Relatrix.findHeadStream('*', '*', ar.get(j).getDomain(), String.class, String.class).forEach(o->{
				Result c = (Result)o;
				displayCtrl();
				if(DISPLAY || DISPLAYALL)
					System.out.println(displayLine+"="+c);
		...
		for(int j = 0; j < ar.size(); j++) {
			displayLine = 0;
			//RelatrixHeadsetIterator.DEBUG = true;
			System.out.println("11."+j+") findHeadStream(*,<obj>,*, String.class, Long.class) using map="+ar.get(j).getDomain());		
			Relatrix.findHeadStream('*', ar.get(j).getDomain(), '*',String.class, Long.class).forEach(o->{
				Result c = (Result)o;
				displayCtrl();
				if(DISPLAY || DISPLAYALL)
					System.out.println(displayLine+"="+c);
			...
			displayLine =0;
			System.out.println("12."+j+") FindHeadStream(<obj>,*,*,String.class, Long.class) using domain="+ar.get(j).getDomain());		
			Relatrix.findHeadStream(ar.get(j).getDomain(), '*', '*',String.class, Long.class).forEach(o->{
				Result c = (Result)o;
				displayCtrl();
				if(DISPLAY || DISPLAYALL)
		...
		for(int j = 0; j < ar.size(); j++) {
			...
			displayLine = 0;
			System.out.println("13."+j+") findHeadStream(*,<obj>,<obj>,String.class) using map="+((Result)ar.get(j)).toArray()[0]+" range="+((Result)ar.get(j)).toArray()[1]);		
			Relatrix.findHeadStream('*', ((Result)ar.get(j)).toArray()[0], ((Result)ar.get(j)).toArray()[1], String.class).forEach(o->{
				Result c = (Result)o;
				displayCtrl();
				if(DISPLAY || DISPLAYALL)
					System.out.println(displayLine+"="+c);
			...
			displayLine = 0;
			System.out.println("14."+j+") findHeadStream(<obj>,*,<obj>,String.class) using domain="+((Result)ar.get(j)).toArray()[0]+", range="+((Result)ar.get(j)).toArray()[1]);		
			Relatrix.findHeadStream(((Result)ar.get(j)).toArray()[0], '*', ((Result)ar.get(j)).toArray()[1], String.class).forEach(o->{
				Result c = (Result)o;
				displayCtrl();
				if(DISPLAY || DISPLAYALL)
		...
		for(int j = 0; j < ar.size(); j++) {
			displayLine=0;
			System.out.println("15."+j+") findHeadStream(<obj>,<obj>,*, Long.class) using domain="+((Result)ar.get(j)).toArray()[0]+", map="+((Result)ar.get(j)).toArray()[1]);		
			Relatrix.findHeadStream(((Result)ar.get(j)).toArray()[0], ((Result)ar.get(j)).toArray()[1], '*', Long.class).forEach(o->{
				Result c = (Result)o;
				displayCtrl();
				if(DISPLAY || DISPLAYALL)
					System.out.println(displayLine+"="+c);
		...
		for(int j = 0; j < ar.size(); j++) {
			displayLine=0;
			System.out.println("16."+j+") findHeadStream(*,*,<obj>, String.class, String.class) using range="+ar.get(j).getDomain());		
			Relatrix.findHeadStream('*', '*', ar.get(j).getDomain(), String.class, String.class).forEach(o->{
				Result c = (Result)o;
				displayCtrl();
				if(DISPLAY || DISPLAYALL)
			...
			displayLine=0;
			System.out.println("17."+j+") findHeadStream(*,<obj>,*, String.class, Long.class) using map="+ar.get(j).getDomain());		
			Relatrix.findHeadStream('*', ar.get(j).getDomain(), '*', String.class, Long.class).forEach(o->{
				Result c = (Result)o;
				displayCtrl();
				if(DISPLAY || DISPLAYALL)
			...
			displayLine=0;
			System.out.println("18."+j+") findHeadStream(<obj>,*,*, String.class, Long.class) using domain="+ar.get(j).getDomain());		
			Relatrix.findHeadStream(ar.get(j).getDomain(), '*', '*', String.class, Long.class).forEach(o->{
				Result c = (Result)o;
				displayCtrl();
				if(DISPLAY || DISPLAYALL)
		...
		for(int j = 0; j < ar.size(); j++) {
			displayLine=0;
			System.out.println("19."+j+") findHeadStream(*,<obj>,<obj>, String.class) using map="+ar.get(j).getDomain()+" range="+ar.get(j).getMap());		
			Relatrix.findHeadStream('*', ar.get(j).getDomain(), ar.get(j).getMap(), String.class).forEach(o->{
				Result c = (Result)o;
				displayCtrl();
				if(DISPLAY || DISPLAYALL)
					System.out.println(displayLine+"="+c);
			...
			displayLine =0;
			System.out.println("20."+j+") findHeadStream(<obj>,*,<obj>,String.class) using domain="+ar.get(j).getDomain()+" range="+ ar.get(j).getMap());		
			Relatrix.findHeadStream(ar.get(j).getDomain(), '*', ar.get(j).getMap(), String.class).forEach(o->{
				Result c = (Result)o;
				displayCtrl();
				if(DISPLAY || DISPLAYALL)
			...
			displayLine =0;
			System.out.println("21."+j+") findHeadStream(<obj>,<obj>,*,Long.class) using domain="+ar.get(j).getDomain()+" map="+ar.get(j).getMap());		
			Relatrix.findHeadStream(ar.get(j).getDomain(), ar.get(j).getMap(), '*',Long.class).forEach(o->{
				Result c = (Result)o;
				displayCtrl();
				if(DISPLAY || DISPLAYALL)
					System.out.println(displayLine+"="+c);
