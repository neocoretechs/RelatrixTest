	...
	*/
	...
	public static void battery1() throws Exception {
		...
		for(int j = 0; j < ar.size(); j++) {
			...
			it = Relatrix.findSubSet(ar3c[0],ar3c[1],ar3c[2]);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			it = Relatrix.findSubSet('*', '*', ((Relation)(((Result)ar.get(j)).get())).getRange(), String.class, String.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
		...
		for(int j = 0; j < ar.size(); j++) {
			...
			it = Relatrix.findSubSet('*', ((Relation)(((Result)ar.get(j)).get())).getMap(), '*',String.class, Long.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			it = Relatrix.findSubSet(((Relation)(((Result)ar.get(j)).get())).getDomain(), '*', '*', String.class, Long.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
		...
		for(int j = 0; j < ar.size(); j++) {
			...
			it = Relatrix.findSubSet('*', arc[1], arc[2], String.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			it = Relatrix.findSubSet(arc[0], '*', arc[2], String.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			it = Relatrix.findSubSet(arc[0], arc[1], '*',Long.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
		...
		for(int j = 0; j < ar.size(); j++) {
			...
			it = Relatrix.findSubSet('*', '*', arc[2], String.class, String.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			it = Relatrix.findSubSet('*', arc[1], '*', String.class, Long.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result1 c = (Result1)o;
				displayCtrl();
			...
			it = Relatrix.findSubSet(arc[0], '*', '*', String.class, Long.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
		...
		for(int j = 0; j < ar2dr.size(); j++) {
			...
			it = Relatrix.findSubSet('*','*','*',arc[0].getClass(), arc[1].getClass(),lo,hi);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
