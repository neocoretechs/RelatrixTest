	...
	*/
	...
	public static void battery1(String[] argv) throws Exception {
		...
		for(int j = 0; j < ar.size(); j++) {
			...
			it = RelatrixJson.findSubSet(ar.get(j).getDomain(), ar.get(j).getMap(), ar.get(j).getRange());
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			System.out.println("10."+j+") findSubSet(*,*,<obj>,"+xClass+"," +xfClass+") using range="+((Result)ar.get(j)).getRange());		
			it = RelatrixJson.findSubSet('*', '*', ((Result)ar.get(j)).getRange(), xClass, xfClass);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
		...
		for(int j = 0; j < ar.size(); j++) {
			...
			displayLine =0;
			System.out.println("12."+j+") FindSubset(<obj>,*,*,"+ xfClass+","+x50Class+") using domain="+ar.get(j).getDomain());		
			it = RelatrixJson.findSubSet(ar.get(j).getDomain(), '*', '*', xfClass, x50Class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
		...
		for(int j = 0; j < ar.size(); j++) {
			...
			displayLine = 0;
			System.out.println("13."+j+") findSubSet(*,<obj>,<obj>,"+xClass+") using map="+RelatrixKVJson.getData(ar.get(j).getDomain())+" range="+RelatrixKVJson.getData(ar.get(j).getMap()));		
			it = RelatrixJson.findSubSet('*', ar.get(j).getDomain(), ar.get(j).getMap(), xClass);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			displayLine = 0;
			System.out.println("14."+j+") findSubSet(<obj>,*,<obj>,"+xfClass+") using ="+RelatrixKVJson.getData(ar.get(j).getDomain())+", "+RelatrixKVJson.getData(ar.get(j).getMap()));		
			it = RelatrixJson.findSubSet(ar.get(j).getDomain(), '*', ar.get(j).getMap(), xfClass);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			displayLine =0;
			System.out.println("15."+j+") findSubSet(<obj>,<obj>,*,"+x50Class+") using domain="+RelatrixKVJson.getData(ar.get(j).getDomain())+", map="+RelatrixKVJson.getData(ar.get(j).getMap()));		
			it = RelatrixJson.findSubSet(ar.get(j).getDomain(), ar.get(j).getMap(), '*',x50Class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
		...
		for(int j = 0; j < ar.size(); j++) {
			displayLine =0;
			System.out.println("16."+j+") findSubSet(*,*,<obj>,"+xClass+","+xfClass+") using range="+ar.get(j).getRange());		
			it = RelatrixJson.findSubSet('*', '*', ar.get(j).getRange(), xClass, xfClass);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			displayLine =0;
			System.out.println("17."+j+") findSubSet(*,<obj>,*,"+xClass+","+x50Class+") using map="+ar.get(j).getMap());		
			it = RelatrixJson.findSubSet('*', ar.get(j).getMap(), '*', xClass, x50Class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
			...
			displayLine =0;
			System.out.println("18."+j+") findSubSet(<obj>,*,*,"+xfClass+","+x50Class+") using domain="+ar.get(j).getDomain());		
			it = RelatrixJson.findSubSet(ar.get(j).getDomain(), '*', '*', xfClass, x50Class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
		...
		for(int j = 0; j < ar.size(); j++) {
			displayLine=0;
			System.out.println("19."+j+") findSubSet(*,<obj>,<obj>,"+xClass+") using map="+RelatrixKVJson.getData(ar.get(j).getDomain())+" range="+RelatrixKVJson.getData(ar.get(j).getMap()));		
			it = RelatrixJson.findSubSet('*', ar.get(j).getDomain(), ar.get(j).getMap(), xClass);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
			...
			displayLine=0;
			System.out.println("20."+j+") findSubSet(<obj>,*,<obj>,+"+xfClass+") using domain="+RelatrixKVJson.getData(ar.get(j).getDomain())+" range="+ RelatrixKVJson.getData(ar.get(j).getMap()));		
			it = RelatrixJson.findSubSet(ar.get(j).getDomain(), '*', ar.get(j).getMap(), xfClass);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
			...
			displayLine=0;
			System.out.println("21."+j+") findSubSet(<obj>,<obj>,*,"+x50Class+") using domain="+RelatrixKVJson.getData(ar.get(j).getDomain())+" map="+RelatrixKVJson.getData(ar.get(j).getMap()));		
			it = RelatrixJson.findSubSet(ar.get(j).getDomain(), ar.get(j).getMap(), '*',x50Class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
