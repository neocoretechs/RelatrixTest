	...
	*/
	...
	public static void battery1(String[] argv) throws Exception {
		...
		for(int j = 0; j < ar3.size(); j++) {
			...
			it = RelatrixJsonTransaction.findSubSet(xid,((Result)ar3.get(j)).get(0), ((Result)ar3.get(j)).get(1), ((Result)ar3.get(j)).get(2));
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
		...
		for(int j = 0; j < ar.size(); j++) {
			...
			it = RelatrixJsonTransaction.findSubSet(xid,'*', ((Result)am.get(j)).get(0), '*',xClass, x50Class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			it = RelatrixJsonTransaction.findSubSet(xid,((Result)ad.get(j)).get(0), '*', '*', xfClass, x50Class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
		...
		for(int j = 0; j < ar2.size(); j++) {
			...
			displayLine = 0;
			System.out.println("13."+j+") findSubSet(*,<obj>,<obj>,"+xClass+") using map="+RelatrixKVJsonTransaction.getData(((Result)ar2.get(j)).toArray()[0])+" range="+RelatrixKVJsonTransaction.getData(((Result)ar2.get(j)).toArray()[1]));		
			it = RelatrixJsonTransaction.findSubSet(xid,'*', ((Result)ar2.get(j)).toArray()[0], ((Result)ar2.get(j)).toArray()[1], xClass);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			displayLine = 0;
			System.out.println("14."+j+") findSubSet(<obj>,*,<obj>,"+xfClass+") using ="+RelatrixKVJsonTransaction.getData(((Result)ar2dr.get(j)).toArray()[0])+", "+RelatrixKVJsonTransaction.getData(((Result)ar2dr.get(j)).toArray()[1]));		
			it = RelatrixJsonTransaction.findSubSet(xid,((Result)ar2dr.get(j)).toArray()[0], '*', ((Result)ar2dr.get(j)).toArray()[1], xfClass);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			displayLine =0;
			System.out.println("15."+j+") findSubSet(<obj>,<obj>,*,"+x50Class+") using domain="+RelatrixKVJsonTransaction.getData(((Result)ar2dm.get(j)).toArray()[0])+", map="+RelatrixKVJsonTransaction.getData(((Result)ar2dm.get(j)).toArray()[1]));		
			it = RelatrixJsonTransaction.findSubSet(xid,((Result)ar2dm.get(j)).toArray()[0], ((Result)ar2dm.get(j)).toArray()[1], '*',x50Class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
		...
		for(int j = 0; j < ar.size(); j++) {
			...
			it = RelatrixJsonTransaction.findSubSet(xid,'*', '*', ((Result)ar.get(j)).get(0), xClass, xfClass);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
		...
		for(int j = 0; j < ar2.size(); j++) {
			displayLine=0;
			System.out.println("19."+j+") findSubSet(?,<obj>,<obj>,"+xClass+") using map="+RelatrixKVJsonTransaction.getData(((Result)ar2.get(j)).get(0))+" range="+RelatrixKVJsonTransaction.getData(((Result)ar2.get(j)).get(1)));		
			it = RelatrixJsonTransaction.findSubSet(xid,'*', ((Result)ar2.get(j)).get(0), ((Result)ar2.get(j)).get(1), xClass);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			displayLine=0;
			System.out.println("20."+j+") findSubSet(<obj>,?,<obj>,+"+xfClass+") using domain="+RelatrixKVJsonTransaction.getData(((Result)ar2dr.get(j)).get(0))+" range="+ RelatrixKVJsonTransaction.getData(((Result)ar2dr.get(j)).get(1)));		
			it = RelatrixJsonTransaction.findSubSet(xid,((Result)ar2dr.get(j)).get(0), '*', ((Result)ar2dr.get(j)).get(1), xfClass);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			displayLine=0;
			System.out.println("21."+j+") findSubSet(<obj>,<obj>,?,"+x50Class+") using domain="+RelatrixKVJsonTransaction.getData(((Result)ar2dm.get(j)).get(0))+" map="+RelatrixKVJsonTransaction.getData(((Result)ar2dm.get(j)).get(1)));		
			it = RelatrixJsonTransaction.findSubSet(xid,((Result)ar2dm.get(j)).get(0), ((Result)ar2dm.get(j)).get(1), '*',x50Class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
		...
		for(int j = 0; j < ar2dm.size(); j++) {
			...
			it = RelatrixJsonTransaction.findSubSet(xid,'*','*','*',((Result)ar2dm.get(j)).get(0).getClass(), ((Result)ar2dm.get(j)).get(1).getClass(),RelatrixKVJsonTransaction.getObject(xo50lo,xid),RelatrixKVJsonTransaction.getObject(xo50hi,xid));
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
