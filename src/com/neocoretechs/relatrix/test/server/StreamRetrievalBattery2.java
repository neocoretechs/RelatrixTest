	...
	private static RelatrixClient rkvc ;
		...
		*/
		public static void main(String[] argv) throws Exception {
			...
			battery1(argv);
			System.out.println("StreamRetrievalBattery2 COMPLETE.");	
			System.exit(1);
		}
		...
		public static void battery1(String[] argv) throws Exception {
			...
			it =  rkvc.findHeadStream('*', '*', '*',String.class, String.class, Long.class);
			...
			for(j = 0; j < ar.size(); j++) {
				...
				if(it != null)
					rkvc.setStream(it);
				it = rkvc.findHeadStream(arel[0],arel[1],arel[2]);
				it.parallel().forEach(e-> {
					Result c = (Result)e;
					displayCtrl();
					if(DISPLAY)
			...
			for(j = 0; j < ar.size(); j++) {
				...
				if(it != null)
					rkvc.setStream(it);
				it = rkvc.findHeadStream('*', '*', arel[2], String.class, String.class);
				it.parallel().forEach(e-> {
					Result c = (Result)e;
					displayCtrl();
					if(DISPLAY)
			...
			for(j = 0; j < ar.size(); j++) {
				...
				if(it != null)
					rkvc.setStream(it);
				it = rkvc.findHeadStream('*', arel[1], '*',String.class, Long.class);
				it.parallel().forEach(e-> {
					Result c = (Result)e;
					displayCtrl();
					if(DISPLAY)
			...
			for(j = 0; j < ar.size(); j++) {
				...
				if(it != null)
					rkvc.setStream(it);
				it = rkvc.findHeadStream(arel[0], '*', '*', String.class, Long.class);
				it.parallel().forEach(e-> {
					Result c = (Result)e;
					displayCtrl();
					if(DISPLAY)
			...
			for(j = 0; j < ar.size(); j++) {
				...
				if(it != null)
					rkvc.setStream(it);
				it = rkvc.findHeadStream('*', arel[1], arel[2], String.class);
			...
			for(j = 0; j < ar.size(); j++) {
				...
				if(it != null)
					rkvc.setStream(it);
				it = rkvc.findHeadStream(arel[0], '*', arel[2], String.class);
				//ar = new ArrayList<Comparable>();
				it.parallel().forEach(e-> {
					Result c = (Result)e;
					displayCtrl();
			...
			for(j = 0; j < ar.size(); j++) {
				...
				if(it != null)
					rkvc.setStream(it);
				it = rkvc.findHeadStream(arel[0], arel[1], '*',Long.class);
				it.parallel().forEach(e-> {
					Result c = (Result)e;
					displayCtrl();
					if(DISPLAY)
			...
			it = rkvc.findHeadStream('*', '*', '*',fkey2,String.class,hi);
			it.parallel().forEach(e-> {
				Result c = (Result)e;
				displayCtrl();
				if(DISPLAY)
			...
			System.out.println("10.) findHeadStream(*,*,*,<obj>,<obj>,String.class,<obj>,<obj>) using domain from "+fkey2+" map=String.class range to "+hi);		
			it = rkvc.findHeadStream('*', '*', '*',fkey2,String.class,hi);
			it.parallel().forEach(e-> {
				Result c = (Result)e;
				displayCtrl();
			...
			if(it != null)
				rkvc.setStream(it);
			fkey2 = key + String.format(uniqKeyFmt, hi);
			System.out.println("11.) findHeadStream(*,*,*,<obj>,<obj>,String.class,<obj>,<obj>) using domain from "+fkey2+" map=String.class range to "+hi);		
			it = rkvc.findHeadStream('*', '*', '*',fkey2,String.class,hi);
			it.parallel().forEach(e-> {
				Result c = (Result)e;
				displayCtrl();
			...
			if(it != null)
				rkvc.setStream(it);
			System.out.println("13.) findHeadStream(*,*,*,String.class,String.class,<obj>,<obj>) using domain=String.class map=String.class range to "+hi);		
			it = rkvc.findHeadStream('*', '*', '*',String.class,String.class,hi);
			it.parallel().forEach(e-> {
				Result c = (Result)e;
				displayCtrl();
			...
			if(it != null)
				rkvc.setStream(it);
			System.out.println("14.) findHeadStream(*,*,*,<obj>,<obj>,<obj>,<obj>) using domain=String.class map=String.class range to "+hi);		
			it = rkvc.findHeadStream('*', '*', '*',String.class,String.class,hi);
			it.parallel().forEach(e-> {
				Result c = (Result)e;
				displayCtrl();
