 ...
 * and verifying findSubSet retrieval using the client to a remote {@link com.neocoretechs.relatrix.server.RelatrixTransactionServer}.
 * NOTES:
 * program arguments are remote_node remote_port_for_database
 * @author Jonathan Groff Copyright (C) NeoCoreTechs 2024
 *
 */
public class ServerRetrievalBatteryTransaction1 {
	...
	public static void battery1(String[] argv) throws Exception {
		...
		it =  rkvc.findSubSet(xid, '*', '*', '*',String.class, String.class, Long.class);
		while(it.hasNext()) {
			Object o = it.next();
			Result c = (Result)o;
			displayCtrl();
		...
		for(int j = 0; j < ar.size(); j++) {
			...
			if(it != null)
				rkvc.setIterator(it);
			it = rkvc.findSubSet(xid, arel[0],arel[1],arel[2]);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			if(it != null)
				rkvc.setIterator(it);
			it = rkvc.findSubSet(xid, '*', '*', arel[2], String.class, String.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			if(it != null)
				rkvc.setIterator(it);
			it = rkvc.findSubSet(xid, '*', arel[1], '*',String.class, Long.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			if(it != null)
				rkvc.setIterator(it);
			it = rkvc.findSubSet(xid, arel[0], '*', '*', String.class, Long.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			if(it != null)
				rkvc.setIterator(it);
			it = rkvc.findSubSet(xid, '*', arel[1], arel[2], String.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			if(it != null)
				rkvc.setIterator(it);
			it = rkvc.findSubSet(xid, arel[0], '*', arel[2], String.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			if(it != null)
				rkvc.setIterator(it);
			it = rkvc.findSubSet(xid, arel[0], arel[1], '*',Long.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
		...
		it = rkvc.findSubSet(xid, '*', '*', '*',fkey1,fkey2,String.class,lo,hi);
		while(it.hasNext()) {
			Object o = it.next();
			Result c = (Result)o;
			displayCtrl();
		...
		it = rkvc.findSubSet(xid, '*', '*', '*',String.class,String.class,lo,hi);
		while(it.hasNext()) {
			Object o = it.next();
			Result c = (Result)o;
			displayCtrl();
