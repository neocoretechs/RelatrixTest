 ...
 * and verifying findTailSet retrieval using the client to a remote {@link com.neocoretechs.relatrix.server.RelatrixServer}.
 * NOTES:
 * program arguments are  remote_node remote_port_for_database
 * @author Jonathan Groff Copyright (C) NeoCoreTechs 2024
 */
public class ServerRetrievalBattery3 {
	...
	private static RelatrixClient rkvc ;
		...
		*/
		...
		public static void battery1(String[] argv) throws Exception {
			...
			it =  rkvc.findTailSet('*', '*', '*',String.class, String.class, Long.class);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			for(int j = 0; j < ar.size(); j++) {
				...
				if(it != null)
					rkvc.setIterator(it);
				it = rkvc.findTailSet(arel[0],arel[1],arel[2]);
				while(it.hasNext()) {
					Object o = it.next();
					Result c = (Result)o;
					displayCtrl();
				...
				if(it != null)
					rkvc.setIterator(it);
				it = rkvc.findTailSet('*', '*', arel[2], String.class, String.class);
				while(it.hasNext()) {
					Object o = it.next();
					Result c = (Result)o;
					displayCtrl();
				...
				if(it != null)
					rkvc.setIterator(it);
				it = rkvc.findTailSet('*', arel[1], '*',String.class, Long.class);
				while(it.hasNext()) {
					Object o = it.next();
					Result c = (Result)o;
					displayCtrl();
				...
				if(it != null)
					rkvc.setIterator(it);
				it = rkvc.findTailSet(arel[0], '*', '*', String.class, Long.class);
				while(it.hasNext()) {
					Object o = it.next();
					Result c = (Result)o;
					displayCtrl();
				...
				if(it != null)
					rkvc.setIterator(it);
				it = rkvc.findTailSet('*', arel[1], arel[2], String.class);
				...
				if(it != null)
					rkvc.setIterator(it);
				it = rkvc.findTailSet(arel[0], '*', arel[2], String.class);
				//ar = new ArrayList<Comparable>();
				while(it.hasNext()) {
					Object o = it.next();
					Result c = (Result)o;
				...
				if(it != null)
					rkvc.setIterator(it);
				it = rkvc.findTailSet(arel[0], arel[1], '*',Long.class);
				//ar = new ArrayList<Comparable>();
				while(it.hasNext()) {
					Object o = it.next();
					Result c = (Result)o;
			...
			it = rkvc.findTailSet('*', '*', '*',fkey2,String.class,hi);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
			...
			it = rkvc.findTailSet('*', '*', '*',String.class,String.class,hi);
			while(it.hasNext()) {
				Object o = it.next();
				Result c = (Result)o;
				displayCtrl();
